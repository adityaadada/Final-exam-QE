...
class TestLogin(unittest.TestCase): 
    ...
    def test_a_4_time(self): 
        ...
        time.sleep(1)        
        browser.find_element(By.ID,"btnView").click() #klik
        time.sleep(1) 
        # validasi
    ...
    def test_a_10_maintenance(self): 
        ...
        browser.find_element(By.ID,"menu_maintenance_purgeEmployee").click() #klik
        time.sleep(1)
        ...
        # validasi
        response_data = browser.find_element(By.ID,'//*[@id="full_name"]').text
